...
const getId = async(req, res)=>{ // trae un pais en particular por id
    ...
    // const index = matchesAll.findIndex(el => el.id_match.toLowerCase() === idMatch.toLowerCase() )// con esto tengo el index para saber donde esta ubicado por su id , puede servir para un delete :)
    // console.log(index) // si da -1 es que no encontro el index
